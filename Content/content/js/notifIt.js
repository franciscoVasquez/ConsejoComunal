...
//Francisco
function MostrarAlertas(Mensaje, Tipo, confirmation) {
    ...
    if (Tipo == "success") {
        ...
        notif_confirm({
            ...
            'fullscreen': true,
            'callback': myCallback,
            'bgcolor': ' rgba(56, 56, 56, 0.93)',
            'img': $('<img src="../Content/Images/correcto.png" class="logo-mensaje">')
        });
    }
    ...
    if (Tipo == "error") {
        ...
        notif_confirm({
            ...
            'callback': myCallback,
            'bgcolor': '  rgba(56, 56, 56, 0.93)',
            'img': $('<img src="../Content/Images/error.png" class="logo-mensaje">')
        });
    }
    if (Tipo == "info") {
        ...
        notif_confirm({
            ...
            'callback': myCallback,
            'bgcolor': '  rgba(56, 56, 56, 0.93)',
            'img': $('<img src="../Content/Images/alerta.png" class="logo-mensaje">')
        });
    }
    if (Tipo == "pregunta") {
        var myCallback = function (choice) {
        ...
        notif_confirm({
            ...
            'callback': myCallback,
            'bgcolor': '  rgba(56, 56, 56, 0.93)',
            'img': $('<img src="../Content/Images/validacion.png" class="logo-mensaje">')
        });
    }
...
//Francisco
function MostrarAlertasUsuarios(Mensaje, Tipo, confirmation) {
    ...
    if (Tipo == "success") {
        ...
        notif_confirm({
            ...
            'callback': myCallback,
            'bgcolor': ' rgba(56, 56, 56, 0.93)',
            'img': $('<img src="../../Content/Images/correcto.png" style="width: 60px;margin-left: 413px;margin-bottom: -60px;">')
        });
    }
    ...
    if (Tipo == "error") {
        ...
        notif_confirm({
            ...
            'callback': myCallback,
            'bgcolor': '  rgba(56, 56, 56, 0.93)',
            'img': $('<img src="../../Content/Images/error.png" style="width: 60px;margin-left: 413px;margin-bottom: -60px;">')
        });
    }
    if (Tipo == "info") {
        ...
        notif_confirm({
            ...
            'callback': myCallback,
            'bgcolor': '  rgba(56, 56, 56, 0.93)',
            'img': $('<img src="../../Content/Images/alerta.png" style="width: 60px;margin-left: 413px;margin-bottom: -60px;">')
        });
    }
    if (Tipo == "pregunta") {
        var myCallback = function (choice) {
        ...
        notif_confirm({
            ...
            'callback': myCallback,
            'bgcolor': '  rgba(56, 56, 56, 0.93)',
            'img': $('<img src="../../Content/Images/validacion.png" style="width: 60px;margin-left: 413px;margin-bottom: -60px;">')
        });
    }
...
//Francisco
function MostrarAlertasInicio(Mensaje, Tipo, confirmation, url) {
    ...
    if (Tipo == "success") {
        ...
        notif_confirm({
            ...
            'callback': myCallback,
            'bgcolor': ' rgba(56, 56, 56, 0.93)',
            'img': $('<img src="' + UrlImagenError + '" style="width: 60px;margin-left: 413px;margin-bottom: -60px;">')
        });
    }
